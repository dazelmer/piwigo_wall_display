...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        vol.Required(
            CONF_HOST,
            description={"suggested_value": "https://piwigo.com"},
        ): str,
...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {"title": f"Piwigo Wall Display Integration - {data[CONF_HOST]}"}


class PiwigoWallDisplayConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Piwigo Wall Display Integration."""
    ...
    def async_get_options_flow(config_entry):
        ...
        # Remove this method and the PiwigoWallDisplay OptionsFlowHandler class
        # if you do not want any options for your integration.
        return PiwigoWallDisplayOptionsFlowHandler(config_entry)
...
class PiwigoWallDisplayOptionsFlowHandler(OptionsFlow):
